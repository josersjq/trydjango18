...
SECRET_KEY = '*h&u9-k(b=7ts4=+!)bzenzppxn4==a$+fe-u-+qmhvpq*fs-!'
...
EMAIL_HOST_USER = 'sanjuanjojo@gmail.com'
EMAIL_HOST_PASSWORD = 'sanjuan6'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "static", "proj_static"),
)
